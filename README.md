...
Internal execution config at `.springfield/execution/config.json` is generated by Guided Setup. Most users should treat it as Springfield-managed internal state.

Advanced/internal setup supports these plan storage modes:

- `Local (recommended)` writes plans under `.springfield/execution/plans`
