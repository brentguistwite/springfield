...
Local-first CLI and TUI entrypoint for defining, explaining, and running work.

## Current Surface

Springfield ships a TUI-first shell plus stable CLI entrypoints for setup and diagnostics. Ralph and Conductor remain internal engines behind the Springfield product surface. Local-first project state, guided setup, and the full product surface are in place.
...
Setup prompts for plan storage:
