...
var exemptParsers = map[string]string{
	...
	"iterationWorkComplete":  "operates on markers already extracted by ScanMarkers (a covered parser)",
	"iterationStoryComplete": "operates on markers already extracted by ScanMarkers (a covered parser)",
