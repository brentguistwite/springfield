...
const (
	SkillPlan          Name = "plan"
	SkillPlanFromIssue Name = "plan-from-issue"
...
`),
	...
	{
		Name:         SkillPlanFromIssue,
		Summary:      "Compile a Springfield batch from issue-tracker work items (Jira, Linear).",
		Purpose:      playbooks.PurposePlan,
		Header:       "Springfield Plan from Issue",
		...
		RelativePath: "skills/plan-from-issue/SKILL.md",
		TaskBody: versionCheckPreamble + "\n\n" + strings.TrimSpace(`
