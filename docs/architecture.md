...
Dependency direction flows downward only: commands depend on features and core; features may depend on core; core depends on nothing internal except shared types.
